Locales['sr'] = {
  ...
  ['allowlist_empty']     = 'Nema sacuvanih lista dozvoljenih za ovaj server.',
  ['license_missing']     = 'Greska: Vas identifikator nedostaje!',
  ['help_allowlist_add']  = 'dodajte nekoga na listu dozvoljenih igraca',
  ['help_allowlist_load'] = 'ponovo ucitajte listu dozvoljenih igraca',
